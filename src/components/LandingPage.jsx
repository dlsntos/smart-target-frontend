...
function LandingPage() {
  ...
  return (
    <>
      <div className="flex w-full absolute top-10 justify-center p-2 z-[10000] flex-row gap-5">
        <b><p className="text-white">Github Links:{"\u00A0"}</p></b>
        <a
          href="https://github.com/dlsntos/smart-target-frontend"
          target="_blank"
        ...
        <a
          href="https://github.com/Sardzzzzz/APSI_Dockerized_Thesis_Backend"
          target="_blank"
          rel="noopener noreferrer"
          className="block text-white underline"
        >
        ...
        <a
          href="https://github.com/dlsntos/smart-target-admin-dashboard"
          target="_blank"
          rel="noopener noreferrer"
          className="block text-white underline"
        >
      ...
      <Link to="/consent">
        <div className="relative bg-black h-screen text-white overflow-hidden flex flex-col cursor-pointer">
          ...
          <div className="flex flex-col items-center justify-center flex-1 z-10 text-center">
            <h1 className="text-5xl font-extrabold mb-10 italic tracking-tighter">
              WELCOME TO INDÚ
            </h1>
